...
export const TEMPLATE_FIXTURES = {
  ...
  "template-pr-fix-single":               { scenario: scenarios.greenPR(61),      inputVars: { item: { repo: "virtengine/bosun", number: "61", n: "61", branch: "feat/fix-pr", base: "main", taskId: "pr-fix-virtengine-bosun-61", taskTitle: "Fix PR #61", claimKey: "virtengine/bosun#61", reason: "ci_rerun_failed", failedCheckNames: ["CI"], url: "https://github.com/virtengine/bosun/pull/61", title: "Fix: test PR" } } },
  "template-pr-security-fix-single":      { scenario: scenarios.greenPR(64),      inputVars: { item: { repo: "virtengine/bosun", number: "64", n: "64", branch: "fix/codeql-64", base: "main", taskId: "pr-secfix-virtengine-bosun-64", taskTitle: "Security Fix PR #64", claimKey: "virtengine/bosun#64:security", reason: "code_scanning_failed", securityCheckNames: ["CodeQL", "code-scanning"], failedCheckNames: ["CodeQL"], alerts: [{ rule: "js/sql-injection", severity: "high", state: "open", tool: "CodeQL" }], url: "https://github.com/virtengine/bosun/pull/64", title: "fix: remediate security findings" } } },
  "template-github-kanban-sync":           { scenario: scenarios.kanbanState(),     inputVars: {} },
  "template-github-pr-event-handler":     { scenario: scenarios.greenPR(62),      inputVars: { prNumber: 62, prBranch: "task/TASK-62-fix", prUrl: "https://github.com/virtengine/bosun/pull/62", prTitle: "fix: something", repo: "virtengine/bosun" } },
  "template-github-check-failure":        { scenario: scenarios.greenPR(63),      inputVars: { prNumber: 63, repo: "virtengine/bosun", checkName: "CI / test" } },
  ...
  "template-recover-blocked-task":       { scenario: scenarios.greenPR(215),      inputVars: { taskId: "TASK-BLOCKED-1", branch: "feat/blocked-task", repoRoot: "/workspace", baseBranch: "main", defaultTargetBranch: "origin/main" } },
  "template-recover-blocked-worktrees":  { scenario: scenarios.greenPR(216),      inputVars: {} },
};
