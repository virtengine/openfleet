...
export const TEMPLATE_FIXTURES = {
  ...
  "template-sub-validation-gate":         { scenario: scenarios.greenPR(98),      inputVars: { taskId: "TASK-7", taskTitle: "Validation Gate", worktreePath: "/tmp/wt/task-7", branch: "feat/task-7", baseBranch: "main" } },
  "template-sub-validate-and-pr":         { scenario: scenarios.greenPR(99),      inputVars: { taskId: "TASK-8", taskTitle: "Validate And PR", worktreePath: "/tmp/wt/task-8", branch: "feat/task-8", baseBranch: "main", prNumber: 99, prUrl: "https://github.com/virtengine/bosun/pull/99", repo: "virtengine/bosun" } },
  "template-sub-pr-handoff":              { scenario: scenarios.greenPR(100),     inputVars: { taskId: "TASK-9", taskTitle: "PR Handoff", worktreePath: "/tmp/wt/task-9", branch: "feat/task-9", baseBranch: "main", prNumber: 100, prUrl: "https://github.com/virtengine/bosun/pull/100", repo: "virtengine/bosun" } },
