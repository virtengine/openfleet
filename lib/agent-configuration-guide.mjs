...
export function buildAgentConfigurationGuide(rawSettings = {}, providerInventory = null) {
  ...
  const providerFabric = {
    ...
    summary: "Enable the harness providers you want Bosun to use, choose a primary provider, then decide whether other enabled providers are dormant, failover-only, or part of spread routing.",
    current: defaultProviderId || null,
    currentLabel: currentProviderLabel ? `${currentProviderLabel} · ${formatRuntimeLabel(providerRoutingMode)}` : formatRuntimeLabel(providerRoutingMode),
    settingKeys: [
