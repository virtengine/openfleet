...
export const SETTINGS_SCHEMA = [
  ...
  { key: "INTERNAL_EXECUTOR_SDK",          label: "Default SDK",                category: "executor", type: "select", defaultVal: "auto", options: ["auto", "codex", "copilot", "claude", "opencode"], description: "Default AI SDK for task execution. 'auto' selects based on availability and task complexity." },
  ...
  { key: "PRIMARY_AGENT",                  label: "Primary Agent SDK",          category: "executor", type: "select", defaultVal: "codex-sdk", options: ["codex-sdk", "copilot-sdk", "claude-sdk", "opencode-sdk"], description: "Which AI SDK handles primary agent sessions and chat commands." },
