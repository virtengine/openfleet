 ...
 *   - [sandbox_workspace_write] — writable_roots span multiple repos
...
export function buildRepoCodexConfig(options = {}) {
  ...
  const parts = [
    ...
    "#",
    "# Global settings (API keys, model providers, writable_roots) live in",
    "# ~/.codex/config.toml and are NOT duplicated here.",
    "",
  ];

  // ── Sandbox permissions ──
  parts.push(buildSandboxPermissions(env.CODEX_SANDBOX_PERMISSIONS || undefined).trim());
  parts.push("");
