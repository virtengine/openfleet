...
### 2.2 ✏️ Interactive Task Editor with AI Copilot
...
### 2.3 📄 Live Diff Preview During Execution
...
### 2.5 🔧 Structured Agent Outcomes (stop/fail schemas)
...
### 2.8 📋 Onboarding Checklist with Resume
...
### 2.9 🔍 Context Compression / Audit Summaries
...
|----------|-----|-------------|--------|--------|
| 🔴 P0 | **Desktop layout is cramped** | Polished desktop-first layout with sidebar, panels, overlays | High | Massive |
| 🔴 P0 | **No workflow visualization** | Task graph DAG with flow diagrams | Medium | High |
| 🟠 P1 | **No diff viewer integration** | Live diff preview with timeline overlay | Medium | High |
| 🟠 P1 | **No structured agent output** | JSON schema validated stop/fail payloads | Medium | High |
| 🟡 P2 | **No artifact system** | Artifact library with provenance and search | High | Medium |
| 🟡 P2 | **No AI-assisted task editor** | Side-panel copilot for manifest editing | Medium | Medium |
| 🟡 P2 | **No onboarding flow** | Progressive checklist with resume | Low | Medium |
| 🟢 P3 | **No audit summaries** | Context compression with structured checkpoints | Medium | Medium |
| 🟢 P3 | **No PR tracking cards** | First-class PR entity cards in run view | Low | Low |
| 🟢 P3 | **No toolbox permission model** | Named capability sets per step | Low | Low |
...
|---------|----------|-----------|--------|
| Desktop UI | ★★★★★ (purpose-built) | ★★☆☆☆ (stretched mobile) | bosun.ai |
| Mobile access | ★★☆☆☆ (web only) | ★★★★★ (native Telegram) | **Ours** |
| Real-time interaction | ★★★☆☆ (async workflow) | ★★★★★ (live chat + WS) | **Ours** |
| Workflow definition | ★★★★★ (YAML manifests) | ★★★☆☆ (task CRUD forms) | bosun.ai |
| Agent transparency | ★★★★☆ (diffs, outcomes) | ★★★☆☆ (chat only) | bosun.ai |
| Multi-agent | ★★☆☆☆ (Coding + PR) | ★★★★★ (Claude/GPT/Codex/Copilot) | **Ours** |
| Self-hosted | ★☆☆☆☆ (SaaS only) | ★★★★★ (fully self-hosted) | **Ours** |
| Team collaboration | ★★★★☆ (artifacts, PRs) | ★★☆☆☆ (single-user focused) | bosun.ai |
