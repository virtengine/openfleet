...
const CODEBASE_AUDIT_SKILL_CONTENT = readFileSync(resolve(__dirname, "skill-codebase-audit.md"), "utf8");
...
`,
  },
  {
    ...
    tags: [
      ...
      "manifest", "conformity", "regeneration", "claude",
    ],
    important: true,
    scope: "global",
    content: CODEBASE_AUDIT_SKILL_CONTENT,
  },
  {
