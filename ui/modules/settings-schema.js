...
export const SETTINGS_SCHEMA = [
  ...
  { key: "VOICE_MODEL",                    label: "Voice Model",                category: "voice", type: "select", defaultVal: "gpt-audio-1.5", options: ["gpt-audio-1.5", "gpt-realtime-1.5", "gpt-4o-realtime-preview-2024-12-17", "gemini-2.5-pro", "gemini-2.5-flash", "gemini-3.0-flash", "gemini-3.1-pro", "claude-sonnet-4.6", "claude-haiku-4.5", "custom"], description: "Audio model for voice sessions. Select 'custom' to enter a model slug manually." },
  { key: "VOICE_VISION_MODEL",             label: "Vision Model",               category: "voice", type: "select", defaultVal: "gpt-4.1-nano", options: ["gpt-4.1-nano", "gpt-4.1-mini", "gpt-4.1", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.0-flash", "gemini-3.1-pro", "claude-sonnet-4.6", "claude-haiku-4.5", "custom"], description: "Vision model for live screen/camera understanding. Select 'custom' to enter a model slug manually." },
  { key: "OPENAI_REALTIME_API_KEY",        label: "OpenAI Realtime Key (legacy)",  category: "voice", type: "secret", sensitive: true, description: "Legacy fallback: single OpenAI Realtime API key. Use the Voice Endpoints card above for multi-endpoint config. Falls back to OPENAI_API_KEY if not set." },
  { key: "AZURE_OPENAI_REALTIME_ENDPOINT", label: "Azure Endpoint (legacy)",        category: "voice", type: "string", description: "Legacy fallback: Azure OpenAI endpoint URL. Use the Voice Endpoints card above for full multi-endpoint config.", validate: "^$|^https?://" },
