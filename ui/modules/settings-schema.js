...
export const SETTINGS_SCHEMA = [
  ...
  { key: "VOICE_VISION_MODEL",             label: "Vision Model",               category: "voice", type: "select", defaultVal: "gpt-4.1-nano", options: ["gpt-4.1-nano", "gpt-4.1-mini", "gpt-4.1", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.0-flash", "gemini-3.1-pro", "claude-3-7-sonnet-latest", "custom"], description: "Vision model for live screen/camera understanding. Select 'custom' to enter a model slug manually." },
