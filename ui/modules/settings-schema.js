...
export const SETTINGS_SCHEMA = [
  ...
  { key: "CONTEXT_SHREDDING_LIVE_TOOL_COMPACTION_ALLOW_COMMANDS", label: "Live Compaction Allowlist", category: "context-shredding", type: "text", defaultVal: "grep,rg,find,git,go,npm,pnpm,yarn,node,python,python3,pytest,docker,kubectl,cargo,gradle,maven,mvn,javac,tsc,jest,vitest,deno", description: "Comma-separated command or tool families eligible for live compaction. Commands outside the allowlist pass through untouched.", advanced: true },
